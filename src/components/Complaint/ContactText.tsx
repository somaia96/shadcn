...
const ContactText = () => {
    return (
        <div className="lg:w-7/12 text-gray-800">
            ...
            <div >
                <p className="font-medium mb-2">  حرصا منا على تأمين افضل الخدمات ومعالجة كافة المشاكل المتعلقة بحياة وراحة المواطنين .
                    نقدم لكم نظام معالجة الشكاوي لتسهيل وتسريع عملية معالجة الشكاوي.
                </p>
                <div>
                    <h3 className="font-bold">يرجى ملئ الطلب التالي بجميع المعلومات</h3>
                    <ol type="1" className="list-decimal list-inside text-gray-700">
                        <li><b>اسم ورقم مقدم الشكوى: </b> للتواصل معكم في حال وجود استفسار عن المشكلة أو المخالفة المقدمة</li>
                        <li><b>صور مرفقة: </b>لتأكيد حدوث المخالفة أو توضيح المشكلة المراد معالجتها  </li>
                        <li><b>مضمون الشكوى: </b> شرح طبيعة المخالفة أو المشكلة المراد معالجتها </li>
                    </ol>
                    جميع الخانات التي تتضمن <span className="text-red-900 font-bold">*</span> هي خانات ضرورية يجب تعبئتها لتستطيع ارسال الشكوى
                    <br />
                    <span className="text-red-900 font-bold text-lg"> تنويه :</span> في حال وجود نقص في احد البنود السابقة قد يتعرض الطلب للاتلاف. يرجى تقديم كافةالمعلومات المطلوبة
                </div>
            </div>
